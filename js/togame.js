$(document).ready(function() {
    ...
    if ($(window).width() > 1024) {
        ...
        $(`.itemContainer:eq(2)`).append(`<a href="../gamebox/breakout/gamebreakout.html"><div class="item"><img class="itemImg" src="../gamebox/breakout/breakout.png" alt="breakout" /><div class="userInfo"><img class="avatar" src="../images/game.svg" alt="" /><span class="username">[PC] Pong</span></div></div></a>`);
        ...
        $(`.itemContainer:eq(0)`).append(`<a href="../gamebox/ball/gameball.html"><div class="item"><img class="itemImg" src="../gamebox/ball/squareobstacle.png" alt="Snake" /><div class="userInfo"><img class="avatar" src="../images/game.svg" alt="" /><span class="username">[PC] Square Obstacles</span></div></div></a>`)
        $(`.itemContainer:eq(1)`).append(`<a href="../gamebox/bong/gamebong.html"><div class="item"><img class="itemImg" src="../gamebox/bong/bong.png" alt="Pong" /><div class="userInfo"><img class="avatar" src="../images/game.svg" alt="" /><span class="username">[PC] Pong</span></div></div></a>`)
        $(`.itemContainer:eq(0)`).append(`<a href="../gamebox/breakout/gamebreakout.html"><div class="item"><img class="itemImg" src="../gamebox/breakout/breakout.png" alt="breakout" /><div class="userInfo"><img class="avatar" src="../images/game.svg" alt="" /><span class="username">[PC] Pong</span></div></div></a>`);
    }
})